...
Please review our [Code of Conduct](https://github.com/wyvrtn/jospi/blob/master/.github/CODE_OF_CONDUCT.md). It is in effect at all times. We expect it to be honored by everyone who contributes to this project. Acting like an asshole will not be tolerated.
...
Review our [Security Policy](https://github.com/wyvrtn/jospi/blob/master/.github/SECURITY.md). **Do not** file a public issue for security vulnerabilities.
...
- **Smaller is better.** Submit **one** pull request per bugfix or feature. A pull request should contain isolated changes pertaining to a single bugfix or feature implementation. **Do not** refactor or reformat code that is unrelated to your change. It is better to **submit many small pull requests** rather than a single large one. Enormous pull requests will take enormous amounts of time to review, or may be rejected altogether.
...
- **Update the CHANGELOG** for all enhancements and bugfixes. Include the corresponding issue number if one exists, and your GitHub username. (example: "- Fixed crash in profile view. #123 @wyvrtn")
...
1. Separate subject from body with a empty line
...
Almost totally written by [@jessesquires](https://github.com/jessesquires).
